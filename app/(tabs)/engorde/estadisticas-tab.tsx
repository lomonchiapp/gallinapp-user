/**
 * Tab de Estadísticas de Pollos de Engorde
 */
...
export default function EstadisticasTab() {
  const { lotes, suscribirseAEngorde } = useEngordeStore();
  ...
  useEffect(() => {
    const unsubscribe = suscribirseAEngorde();
    console.log('📊 EstadisticasTab Engorde: Componente montado');
    return () => unsubscribe;
  }, []);
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <Card style={styles.summaryCard}>
        ...
        <View style={styles.summaryGrid}>
          ...
          <View style={styles.summaryItem}>
            <Ionicons name="people" size={24} color={colors.engorde} />
      ...
      <Card style={styles.metricsCard}>
        ...
        <View style={styles.metricsList}>
          ...
          <View style={styles.metricItem}>
            ...
            <View style={styles.metricValue}>
              <Text style={[styles.metricNumber, { color: colors.engorde }]}>
      ...
      <Card style={styles.efficiencyCard}>
        ...
        <View style={styles.efficiencyItem}>
          ...
          <View style={styles.efficiencyContent}>
            <Text style={styles.efficiencyLabel}>Lotes Listos para Sacrificio (+8 semanas)</Text>
            <Text style={styles.efficiencyValue}>
      ...
      <Card style={styles.projectionCard}>
        <Text style={styles.cardTitle}>Proyecciones de Sacrificio</Text>
        <Text style={styles.cardSubtitle}>Basado en el estado actual de los lotes</Text>
        
        <View style={styles.projectionItem}>
          <Text style={styles.projectionLabel}>Pollos Listos para Sacrificio (8+ semanas)</Text>
        ...
        <View style={styles.projectionItem}>
          <Text style={styles.projectionLabel}>Pollos en Engorde (4-7 semanas)</Text>
          <Text style={styles.projectionValue}>
            {estadisticasPorLote.filter(lote => lote.edadSemanas >= 4 && lote.edadSemanas < 8).length} lotes
          </Text>
        </View>
