/**
 * Pantalla para crear un nuevo lote de pollos de engorde
 */
...
export default function NuevoLoteEngordeScreen() {
  ...
  const { crearLote, isLoading } = useEngorde();
  ...
  const handleCrearLote = async () => {
    ...
    if (!galponSeleccionado) {
      Alert.alert('Galpón requerido', 'Selecciona el galpón donde ubicaremos el lote.');
      return;
    }
    ...
    try {
      ...
      Alert.alert(
        'Éxito', 
        'Lote de engorde creado correctamente',
      ...
      Alert.alert(
        'Error', 
        error.message || 'Error al crear el lote de engorde'
      );
    }
  };
        ...
        <View style={styles.costSection}>
          ...
          <View style={styles.switchContainer}>
            ...
            <Switch
              ...
              trackColor={{ false: colors.lightGray, true: colors.engorde }}
