/**
 * Formulario dinámico para registrar peso de pollos de engorde
 */
...
import { WeightUnit, WeightValue, convertToKg, convertToPounds, formatWeight, getUnitLabel, validateWeight } from '../../../../src/utils/weightUtils';
...
export default function RegistrarPesoEngordeScreen() {
  ...
  const { loteActual, cargarLote, isLoading: loteLoading, error } = useEngordeStore();
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Registrar Peso - Engorde</Text>
...
const styles = StyleSheet.create({
  ...
  unitButtonActive: {
    backgroundColor: colors.engorde,
  },
  unitButtonText: {
    fontSize: 14,
    fontWeight: '600',
  ...
  estadisticasChip: {
    backgroundColor: colors.engorde + '20',
