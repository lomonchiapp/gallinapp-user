...
export default function DetallesLotePonedora() {
  ...
  const handleRegistrarProduccion = () => {
    router.push({
      pathname: '/(tabs)/mi-granja/ponedoras/registrar-produccion',
      params: { loteId: id }
    });
  };
  ...
  const handleRegistrarMuerte = () => {
    router.push({
      pathname: '/(tabs)/mi-granja/ponedoras/registrar-muerte',
      params: { loteId: id }
    });
  };
              ...
              <View style={styles.menuModal}>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    router.push(`/(tabs)/mi-granja/ponedoras/editar-lote?loteId=${loteActual?.id}`);
                  }}
                >
  ...
  return (
    <View style={styles.tabContent}>
      ...
      <CostoProduccionHuevos
        ...
        showDetailed={false}
        onNavigateToDetails={() => router.push(`/(tabs)/mi-granja/ponedoras/dashboard-costos-huevos?loteId=${lote.id}`)}
      />
        ...
        <Card style={styles.statsCard}>
          ...
          <View style={styles.statsGrid}>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push(`/(tabs)/mi-granja/ponedoras/historial-gastos?loteId=${lote.id}&tipoLote=${TipoAve.PONEDORA}`)}
              activeOpacity={0.7}
            >
              <Text style={styles.statValue}>
    ...
    <View style={styles.tabContent}>
      <View style={styles.tabHeader}>
        ...
        <Button
          ...
          onPress={() => router.push(`/(tabs)/mi-granja/ponedoras/dashboard-costos-huevos?loteId=${lote.id}`)}
          size="small"
        />
      </View>
