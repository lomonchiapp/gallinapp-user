/**
 * Formulario para editar un lote de levantes existente
 */
...
export default function EditarLoteLevantesScreen() {
    const { loteId } = useLocalSearchParams<{ loteId: string }>();
    const { loteActual, cargarLote, actualizarLote, isLoading, error } = useLevantesStore();
            ...
            <Card style={styles.card}>
                ...
                <View style={styles.formGroup}>
                    ...
                    <Input
                        ...
                        placeholder="Ej: Lote Levantes 001"
                        maxLength={50}
                    />
                </View>
                    ...
                    <View style={styles.modalContent}>
                        ...
                        {RAZAS_LEVANTE.map((razaOption) => (
                            ...
                            >
                                ...
                                {raza === razaOption && (
                                    <Ionicons name="checkmark" size={20} color={colors.israelies} />
                                )}
                            </TouchableOpacity>
                        ))}
                    </View>
